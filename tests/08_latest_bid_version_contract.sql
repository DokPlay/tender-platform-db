...
OVERRIDING SYSTEM VALUE
SELECT 2301, 2301, 3, 1, 950.00, bounds.period_start, 'admitted'
  FROM report_bounds bounds
UNION ALL
SELECT 2302, 2301, 3, 2, 940.00, bounds.period_start + INTERVAL '1 hour', 'admitted'
  FROM report_bounds bounds
UNION ALL
SELECT 2303, 2301, 4, 1, 930.00, bounds.period_start + INTERVAL '2 hours', 'admitted'
  FROM report_bounds bounds
UNION ALL
SELECT 2304, 2301, 4, 2, 920.00, bounds.period_start + INTERVAL '3 hours', 'withdrawn'
  FROM report_bounds bounds
UNION ALL
SELECT 2305, 2301, 5, 1, 910.00, bounds.period_start + INTERVAL '4 hours', 'rejected'
  FROM report_bounds bounds
UNION ALL
SELECT 2306, 2301, 5, 2, 900.00, bounds.period_start + INTERVAL '5 hours', 'admitted'
  FROM report_bounds bounds;
